...
FDOY   = 32           # Order of approximation (Numerical scheme)
...
GeomPSE = Geom(coords, Lref, Nx, 8, Y0=0, Yf=Yf, dywall=5)
NumMethod = NumericalMethod(GeomNS, GeomPSE, FDOX=FDOX, FDOY=FDOY, stabCoeff=2)
NumMethod.SetUp()
...
setParam.dic['io']['SaveName']   = '../_results/example2'
...
# Plotting graph
plotStuff.plotAll(Param, Flow, Fluc, Igraph, example=2)
